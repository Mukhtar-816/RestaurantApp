...
const Onboarding3 = ({ navigation }) => {
  ...
  //Data 
  const Images = [
    { id: 2, Txt: 'Enjoy instant delivery and payment', Image: 'https://cdni.iconscout.com/illustration/premium/thumb/food-delivery-boy-4047433-3351728.png?f=webp' },
  ];
      ...
      <View style={{ flex: 1 }}>
        ...
        <View style={{ alignItems: 'center', flex: 1 }}>
          ...
          <View style={{ alignItems: 'center', justifyContent: 'center', paddingHorizontal: widthToDp(6), gap: 5 }}>
            <Text style={{ color: Colors.primary, fontWeight: 'bold', fontSize: 25 }}>Fast Delivery...!</Text>
            <Text style={{ color: Colors.gray, textAlign: 'center', fontSize: 15 }}>Book whatever you want to eat and get your meal on your table within time.</Text>
          </View>
